        ...
        <div className="w-full sizeProductCard max-w-[16rem] bg-white border border-gray-300 rounded-lg shadow flex flex-col justify-between h-fit">
            ...
            <div className="px-5 pb-5">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <button onClick={() => addToCheckout(product.id)} className="text-white bg-primary focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Add to cart</button>
                </div>
            </div>
        </div>
    )
